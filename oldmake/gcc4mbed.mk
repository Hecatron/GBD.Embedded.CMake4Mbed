...
MBED_LIB_SRC_ROOT    := $(GCC4MBED_DIR)/deps/mbed/libraries
MBED_SRC_ROOT        := $(MBED_LIB_SRC_ROOT)/mbed


# Root directories for official mbed library output.
LIB_RELEASE_DIR := $(GCC4MBED_DIR)/deps/mbed/Release
LIB_DEBUG_DIR   := $(GCC4MBED_DIR)/deps/mbed/Debug
...
ALL_DEVICE_MAKEFILES := $(wildcard $(GCC4MBED_DIR)/oldmake/*-device.mk)
ALL_DEVICES          := $(patsubst $(GCC4MBED_DIR)/oldmake/%-device.mk,%,$(ALL_DEVICE_MAKEFILES))
