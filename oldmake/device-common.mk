...
EXTERNAL_DIR = $(GCC4MBED_DIR)/deps

# Include path which points to subdirectories of this project, MRI, and user specified directory.
INCLUDE_DIRS := $(patsubst %,-I%,$(INCDIRS) $(SRC) $(call filter_dirs,$(call recurse_dir,$(SRC)),$(TARGETS_FOR_DEVICE)) $(GCC4MBED_DIR)/deps/mri)
...
# Linker Options.
$(MBED_DEVICE): LD_FLAGS := $(LD_FLAGS) -specs=$(GCC4MBED_DIR)/oldmake/startfile.spec
...
ifeq "$(NEWLIB_NANO)" "1"
$(MBED_DEVICE): LD_FLAGS += -specs=$(GCC4MBED_DIR)/oldmake/nano.specs
endif
